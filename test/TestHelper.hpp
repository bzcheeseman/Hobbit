...
std::unique_ptr<llvm::Module> CreateLLVMModule(llvm::LLVMContext &ctx,
                                               const std::string &module_name) {
  return llvm::make_unique<llvm::Module>(module_name, ctx);
}

template <class... Args>
llvm::Function *CreateLLVMFunction(std::unique_ptr<llvm::Module> &module,
                                   const std::string &name, llvm::Type *ret_ty,
                                   Args... args) {
...
void FinalizeModule(std::unique_ptr<llvm::Module> &module,
                    unsigned int opt_level, const std::string &target_triple,
