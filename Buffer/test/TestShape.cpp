...
TEST(TestShape, Chunk) {
  ...
  Hobbit::Shape chunk_shape = shape.GetChunkShape(Hobbit::Range(0, 2), Hobbit::Range(0, 46), Hobbit::Range(0, 46));
  EXPECT_TRUE(chunk_shape == Hobbit::Shape(2, 46, 46));

  Hobbit::Range chunk_idx = shape.GetChunkIdx(Hobbit::Range(0, 2), Hobbit::Range(0, 46), Hobbit::Range(0, 46));
