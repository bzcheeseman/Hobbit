...
llvm::Type *GetType(TypeID type, llvm::LLVMContext &ctx) {
  switch(type) {
    ...
    case INT16: return llvm::Type::getInt16Ty(ctx);
    case INT32: return llvm::Type::getInt32Ty(ctx);
    case INT64: return llvm::Type::getInt64Ty(ctx);
    case FLOAT16: return llvm::Type::getHalfTy(ctx);
    case FLOAT32: return llvm::Type::getFloatTy(ctx);
    case FLOAT64: return llvm::Type::getDoubleTy(ctx);
